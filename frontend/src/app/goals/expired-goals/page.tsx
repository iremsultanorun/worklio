...
export default function ExpiredGoalsPage() {
  ...
  return (
    <div className="p-4 flex flex-col gap-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-gray-900">Süresi Geçen Hedefler</h1>
          <p className="text-sm text-gray-500">{goals.length} hedef</p>
        </div>
      </div>
      <GoalsList goals={goals} type="expired" onRefresh={fetchGoals} />
    </div>
  )
}